int leftLampSize = 200;
int rightLampSize = 100;
...
void draw() {
  ...
  int temp = leftLampSize;
  leftLampSize = rightLampSize;
  rightLampSize = temp;

  // leftLampSize  = leftLampSize + rightLampSize;
  // rightLampSize = leftLampSize - rightLampSize;
  // leftLampSize  = leftLampSize - rightLampSize;
